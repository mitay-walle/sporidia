...
namespace Kellojo.SimpleLootTable
{
	...
	{
		[SerializeField, Tooltip("The weight to get no drop when rolling for an optional drop. 0 indicates that you will always receive something.")] protected int NoDropWeight = 100;
